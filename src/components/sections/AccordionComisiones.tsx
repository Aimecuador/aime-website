...
const comisiones = [
  {
    ...
    director: {
      ...
      role: 'Director Ejecutivo Comisión Técnicas de Especialidades Legal y Responsabilidad Social',
  ...
  },
  {
    ...
    director: {
      ...
      role: 'Director Ejecutivo Comisión Técnicas de Seguridad, Salud y Ambiente SSA',
  ...
  },
  {
    ...
    director: {
      ...
      role: 'Director Ejecutivo Comisión Técnicas de Especialidades de Auditoría Minera',
      ...
      <Accordion type="multiple" className="w-full">
        {comisiones.map((comision) => (
          <AccordionItem key={comision.id} value={comision.id}>
            <AccordionTrigger className="group p-4 hover:no-underline data-[state=open]:bg-muted">
              <div className="flex items-center gap-3">
                <div className="flex flex-col items-start">
                  <h2 className="text-left text-xl font-semibold transition-colors group-data-[state=open]:text-primary">
                    {comision.title}
                  </h2>
            ...
            <AccordionContent>
              <div className="pb-4 pt-2">
                ...
                <div className="mb-6 flex flex-col gap-4 rounded-lg p-4 sm:flex-row">
                ...
                <div>
                  <h3 className="mb-3 flex items-center text-lg font-semibold">
                    <div className="mr-2 h-1 w-6 bg-primary"></div>
